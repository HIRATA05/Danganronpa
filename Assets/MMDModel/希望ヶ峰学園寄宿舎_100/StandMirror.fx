...
float3 MirrorColor = float3(0.8, 0.8, 0.8 ); // 鏡面の乗算色(RGB)
...
//MMM対応
    ...
    #if(FLG_EXCEPTION == 0)
        #define OFFSCREEN_FX_OBJECT  "MirrorWF_v005/Stand_MWF_Object.fxsub"      // オフスクリーン鏡像描画エフェクト
    #else
        #define OFFSCREEN_FX_OBJECT  "MirrorWF_v005/Stand_MWF_ObjectExc.fxsub"   // オフスクリーン鏡像描画エフェクト
    #endif
    #define GET_VPMAT(p) (ViewProjMatrix)
#else
    #define OFFSCREEN_FX_OBJECT  "MirrorWF_v005/Stand_MWF_Object_MMM.fxsub" // オフスクリーンモデル描画エフェクト
